...
<div class="container">
    <div class="row">
        ...
        <form action="/pemeriksaanawal/pasien/{{$pasien->id}}/edit" method="post">
            @csrf
            @method('patch')
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="keluhanutama" name="keluhanutama" value="{{ old('keluhanutama') ?? $pasien->keluhanutama}}">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="tinggibadan" name="tinggibadan" value="{{ old('tinggibadan') ?? $pasien->tinggibadan}}">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="beratbadan" name="beratbadan" value="{{ old('beratbadan') ?? $pasien->beratbadan}}">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="lingkarperut" name="lingkarperut" value="{{ old('lingkarperut') ?? $pasien->lingkarperut}}">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="tekanandarah" name="tekanandarah" value="{{ old('tekanandarah') ?? $pasien->tekanandarah}}">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="pernafasan" name="pernafasan" value="{{ old('pernafasan') ?? $pasien->pernafasan}}">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="detakjantung" name="detakjantung" value="{{ old('detakjantung') ?? $pasien->detakjantung}}">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="suhu" name="suhu" value="{{ old('suhu') ?? $pasien->suhu}}">
        ...
        <div class="col-lg-12">
            <div class="form-group">
              ...
              <textarea class="form-control" id="pemeriksaanawal" rows="3" name="pemeriksaanawal">{{ old('pemeriksaanawal') ?? $pasien->pemeriksaanawal}}</textarea>

...
<div class="container">
    <div class="row">
        ...
        <form action="/pendaftaran/kepalakeluarga" method="post">
            @csrf
        <div class="card border-dark mb-3">
      <div class="card-header"><label for="norm" class="font-weight-bold">Nomor Rekam Medik</label> <input type="text" class="form-control"  id="norm" name="norm" value="{{ old('norm') }}">
                @error('norm')
                  <div class="text text-danger">nomor rekam medik harus diisi dan terdiri angka</div>
                @enderror
      </div>
      <div class="card-body text-dark">
        <p class="card-title"><label for="kepalakeluarga" class="font-weight-bold">Kepala Keluarga</label><input type="text" class="form-control" id="kepalakeluarga" name="kepalakeluarga" value="{{ old('kepalakeluarga') }}">@error('kepalakeluarga')<label class="text text-danger">nama kepala keluarga harus diisi</label>@enderror</p>
        <p class="card-text"><label for="kartukeluarga" class="font-weight-bold">Nomor Kartu Keluarga</label><input type="text" class="form-control" id="kartukeluarga" name="kartukeluarga" value="{{ old('kartukeluarga') }}">@error('kartukeluarga')<label class="text text-danger">nomor kartu keluarga harus diisi dan terdiri angka 16 digit</label>@enderror
        </p>

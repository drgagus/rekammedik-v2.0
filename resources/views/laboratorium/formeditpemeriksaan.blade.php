...
<form action="/laboratorium/pemeriksaan/{{$lab->id}}/edit" method="post">
<div class="row mt-2">
            @csrf
            @method('patch')
    <div class="col-lg-3">
        <div class="form-group">
                <select class="form-control" id="typeoflab_id" name="typeoflab_id">
                    ...
                    <option {{ $lab->typeoflab_id == $typeoflab -> id ? 'selected':'' }} value={{$typeoflab->id}} >{{$typeoflab->tipe}}</option>
                    @endforeach
                </select>
    ...
    <div class="col-lg-3">
        <div class="form-group">
            <input type="text" class="form-control" id="pemeriksaan" name="pemeriksaan" value="{{$lab->pemeriksaan}}">
    ...
    <div class="col-lg-1">
        <div class="form-group">
        <input id="active" type="checkbox" name="active" {{$lab->active === 1  ? 'checked':'' }} value="1"> <label for="active" class="">Aktif</label>
        </div>
    </div>

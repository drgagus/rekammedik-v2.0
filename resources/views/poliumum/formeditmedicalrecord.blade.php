  ...
  <li class="list-group-item d-flex justify-content-between align-items-center">
    ...
    <span class="btn btn-dark">{{date('d M Y', strtotime($medicalrecord->tanggalkunjungan))}}</span>
      ...
      <div class="col-lg-6 text-right">
        <a class="btn btn-sm btn-primary" href="/poliumum/pasien/{{$pasien->id}}" target=_blank>Rekam Medik</a>
        <!-- ----hapus----- -->
...
@endif
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="/poliumum/pasien/{{$medicalrecord->id}}" method="post">
                    @csrf
                    @method('delete')
                    <div class="row">
      ...
      <form action="/poliumum/pasien/{{$medicalrecord->id}}/edit" method="post">
            @csrf
            @method('patch')

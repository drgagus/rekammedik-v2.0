...
<form action="/admin/poli/{{$poli->id}}/edit" method="post">
<div class="row mt-2">
            @csrf
            @method('patch')
    <div class="col-lg-1">
        <div class="form-group">
            <input type="text" class="form-control @error('id') is-invalid @enderror" id="id" name="id" value="{{ old('id') ?? $poli->id}}">
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group">
            <input type="text" class="form-control @error('room') is-invalid @enderror" id="room" name="room" value="{{ old('room') ?? $poli->room}}" >
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <tbody>
                    ...
                    <tr>
                    <td class="">{{$room->id}}</td>
                    <td class=""><a href="/admin/poli/{{$room->id}}/edit" class="text-decoration-none text-dark font-weight-bold">{{$room->room}}</a></td>
                    <td class="">
<!-- ----hapus----- -->

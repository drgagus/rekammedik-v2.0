                    ...
                    <form method="POST" action="/admin/user">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" name="jabatan" autofocus>
                                ...
                                <option  {{ old('jabatan') === 'dokter' ? 'selected':'' }} value="dokter" >Dokter</option>
                                ...
                                <option  {{ old('jabatan') === 'pendaftaran' ? 'selected':'' }} value="pendaftaran" >Pendaftaran</option>
                                <option  {{ old('jabatan') === 'kasir' ? 'selected':'' }} value="kasir" >Kasir</option>
                            </select>

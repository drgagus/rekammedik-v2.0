...
<div class="row mt-2">
    ...
    <div class="col-lg-1">
        <div class="form-group">
            <input type="text" class="form-control @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode')}}" Placeholder="Kode">
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group">
            <input type="text" class="form-control @error('diagnosa') is-invalid @enderror" id="diagnosa" name="diagnosa" value="{{ old('diagnosa')}}" Placeholder="Nama Diagnosa Baru">
        </div>
    </div>

...
class LabrecordController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('poligigi/formceklab', [
            'pasien'=> $pasien,
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/poligigi/pasien')->with('status', 'Form Cek-Lab Telah Diisi.');
    }
    ...
    public function edit($id)
    {
        ...
        foreach ($labrecords as $labrecord):
            if ($labrecord->hasil):
                return redirect('/poligigi/pasien')->with('status', 'Form Cek-Lab Tidak Dapat Diubah, Hasil Lab Telah Keluar.');
            else:
            endif;
        endforeach;
        $typeoflabs = typeoflab::get();
        ...
        return view('poligigi/formeditceklab', [
            'pasien'=> $pasien,
            'medicalrecord' => $medicalrecord,
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/poligigi/pasien')->with('status', 'Form Cek-Lab Telah Diubah.');
    }

...
class LabrecordController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('polikia/formceklab', [
            'pasien'=> $pasien,
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/polikia/pasien')->with('status', 'Form Cek-Lab Telah Diisi.');
    }
    ...
    public function edit($id)
    {
        ...
        foreach ($labrecords as $labrecord):
            if ($labrecord->hasil):
                return redirect('/polikia/pasien')->with('status', 'Form Cek-Lab Tidak Dapat Diubah, Hasil Lab Telah Keluar.');
            else:
            endif;
        endforeach;
        $typeoflabs = typeoflab::get();
        ...
        return view('polikia/formeditceklab', [
            'pasien'=> $pasien,
            'medicalrecord' => $medicalrecord,
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/polikia/pasien')->with('status', 'Form Cek-Lab Telah Diubah.');
    }
